          ...
          {filteredProjects.map((project, index) => {
            ...
            return (
              <div
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-[#FF6B6B] via-[#FF8E8E] to-[#FF4757] rounded-2xl opacity-0 group-hover:opacity-10 blur-xl transition-all duration-700 group-hover:blur-2xl"></div>
                <div className="relative bg-black/60 backdrop-blur-xl rounded-2xl p-6 lg:p-8 border border-white/5 hover:border-[#FF6B6B]/20 transition-all duration-500 h-full overflow-hidden group-hover:transform group-hover:-translate-y-1">
                  <CardContent />
                </div>
              </div>
            )
